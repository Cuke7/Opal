<template>
    <div class="h-full bg-gray-900 flex justify-start items-center flex-col px-8 font-mono overflow-y-auto text-neutral-content">
        <div class="w-full lg:w-2/6">
            ...
            <div class="font-mono text-lg bg-neutral rounded-lg p-4 pb-2 ml-2">
